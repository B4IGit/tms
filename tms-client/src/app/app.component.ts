          ...
          <nav class="nav">
            <div class="logo">
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                   width="34" height="34" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="navbar_links">
              <ul class="navbar_list">
                <li class="nav_item"><a class="navbar_link" routerLink="/">Home</a></li>
                <li class="nav_item"><a class="navbar_link" routerLink="/task-list">Tasks</a></li>
                <li class="nav_item"><a class="navbar_link" routerLink="/projects">Projects</a></li>
              </ul>
